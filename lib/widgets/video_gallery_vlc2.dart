...
class VideoGalleryVlcPlayer3 extends StatefulWidget {
  const VideoGalleryVlcPlayer3({Key? key}) : super(key: key);

  @override
  State<VideoGalleryVlcPlayer3> createState() => _VideoGalleryVlcPlayer3State();
}

class _VideoGalleryVlcPlayer3State extends State<VideoGalleryVlcPlayer3> {
